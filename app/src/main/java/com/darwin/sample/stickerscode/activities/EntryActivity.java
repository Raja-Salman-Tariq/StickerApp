...
import com.darwin.sample.stickerscode.utils.StickerPackValidator;
...
//        }
    ...
    private void showStickerPack(ArrayList<StickerPack> stickerPackList) {
        ...
        ArrayList tmp = new StickerAndPackHandler().get(this);
        if (tmp!=null) {
            stickerPackList.addAll(tmp);
            Log.d("stickerpacksz", "size="+stickerPackList.size());
//            Log.d("PackListCkeck", "showStickerPack1: "+stickerPackList.get(2).custom+" "+stickerPackList.get(2).publisher);
        }
        else Log.d("StickerAdder", "FAILED !");

        progressBar.setVisibility(View.GONE);
        if (stickerPackList.size() > 1) {
            final Intent intent = new Intent(this, StickerPackListActivity.class);
//            Log.d("PackListCkeck", "showStickerPack2: "+stickerPackList.get(2).custom+" "+stickerPackList.get(2).publisher);
        ...
        protected void onPostExecute(Pair<String, ArrayList<StickerPack>> stringListPair) {
            ...
            if (entryActivity != null) {
                if (stringListPair.first != null) {
                    ...
                    entryActivity.showStickerPack(new ArrayList(new HashSet(stringListPair.second){
