...
//                    stickerPreviewAdapter.notifyItemInserted(stickerPack.getStickers().size());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (stickerPack.custom)
            trayUri = Uri.fromFile(new File(getExternalFilesDir(null),"custom_stickers"+File.separator+stickerPack.identifier+File.separator+"tray.webp"));
        else
            trayUri = StickerPackLoader.getStickerAssetUri(stickerPack.identifier, stickerPack.trayImageFile);
        packTrayIcon.setImageURI(trayUri);
